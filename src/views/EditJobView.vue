            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <select v-model="form.type" name="type" id="type" class="border rounded w-full py-2 px-3"
                            required>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.title" type="text" id="name" class="border rounded w-full py-2 px-3 mb-2"
                            placeholder="eg. Beautiful Apartment In Miami" required>
                    </div>
                    <div class="mb-4">
                        <label for="type" class="block text-gray-700 font-bold mb-2">Description</label>
                        <textarea v-model="form.description" name="description" id="description"
                            class="border rounded w-full py-2 px-2" rows="4"
                            placeholder="Add any jon duties, expectations, requirement, etc"></textarea>
                    </div>
                    <div class="mb-4">
                        <label for="type" class="block text-gray-700 font-bold mb-2">Salary</label>
                        <select v-model="form.salary" name="salary" id="salary" class="border rounded w-full py-2 px-3">
                    ...
                    <div class="mb-4">
                        <label for="type" class="block text-gray-700 font-bold mb-2">Location</label>
                    ...
                    <div class="mb-4">
                        <label for="type" class="block text-gray-700 font-bold mb-2">Company Name</label>
                        <input v-model="form.company.name" type="text" name="company" id="company"
                            class="border rounded w-full py-2 px-3" placeholder="name">
                    </div>
                    <div class="mb-4">
                        <label for="type" class="block text-gray-700 font-bold mb-2">Company Description</label>
                        <textarea v-model="form.company.description" name="company_description" id="company_description"
                            class="border rounded w-full py-2 px-2" rows="4"
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contactEmail" type="text" name="contact_email" id="contact_email"
